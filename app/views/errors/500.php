...
<head>
    ...
    <title>Error del servidor - Cruz Motor SAC</title>
            ...
            <div class="col-md-6 text-center">
                <div class="card shadow">
                    <div class="card-body py-5">
                        <i class="fas fa-server text-danger display-1 mb-4"></i>
                        <h1 class="display-4 text-dark mb-3">500</h1>
                        <h2 class="h4 text-muted mb-4">Error interno del servidor</h2>
